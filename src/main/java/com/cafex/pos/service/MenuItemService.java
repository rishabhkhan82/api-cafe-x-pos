...
public interface MenuItemService {
    ...
    MenuItemPageResponse getMenuItemsWithFilters(String name, String category, String restaurantId, String isAvailable, String isActive, String isVegetarian, String isSpicy, int page, int size);
