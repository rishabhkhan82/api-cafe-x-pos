...
public class OrderController {
    ...
    public ResponseEntity<OrderPageResponse> getOrders(
        ...
        log.info("Get orders request received with filters - orderId: {}, status: {}, customerName: {}, date: {}, customerId: {}, invoiceId: {}, page: {}, size: {}",
                orderId, status, customerName, date, customerId, invoiceId, page, size);
        OrderPageResponse response = orderService.getOrdersWithFilters(orderId, status, customerName, date, customerId, invoiceId, page, size);
