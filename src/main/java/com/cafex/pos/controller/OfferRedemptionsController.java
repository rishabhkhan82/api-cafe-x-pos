...
public class OfferRedemptionsController {
    ...
    public ResponseEntity<OperationResponse> createRedemption(@Valid @RequestBody OfferRedemptionRequest request) {
        ...
        try {
            ...
            log.error("Failed to create offer redemption: {}", e.getMessage());
            OperationResponse operationResponse = new OperationResponse("failure", "OFFER_REDEMPTION_CREATE_FAILED", null, null);
    ...
    public ResponseEntity<OperationResponse> updateRedemption(@PathVariable Long id, @Valid @RequestBody OfferRedemptionRequest request) {
        ...
        try {
            ...
            log.error("Failed to update offer redemption: {}", e.getMessage());
            OperationResponse operationResponse = new OperationResponse("failure", "OFFER_REDEMPTION_UPDATE_FAILED", id, null);
            return ResponseEntity.badRequest().body(operationResponse);
        }
    }
    ...
    public ResponseEntity<OfferRedemptionPageResponse> getRedemptions(
        ...
        try {
            ...
            log.error("Failed to get offer redemptions: {}", e.getMessage());
    ...
    public ResponseEntity<OfferRedemptionResponse> getRedemptionById(@PathVariable Long id) {
        ...
        try {
            OfferRedemptionResponse response = offerRedemptionsService.getRedemptionById(id)
                    .orElseThrow(() -> new RuntimeException("Offer redemption not found"));
            log.info("Offer redemption retrieved successfully with ID: {}", response.getId());
            return ResponseEntity.ok(response);
        } catch (Exception e) {
            log.error("Failed to get offer redemption: {}", e.getMessage());
            return ResponseEntity.badRequest().build();
        }
    }
    ...
    public ResponseEntity<OperationResponse> deleteRedemption(@PathVariable Long id) {
        ...
        try {
            ...
            log.error("Failed to delete offer redemption: {}", e.getMessage());
            OperationResponse operationResponse = new OperationResponse("failure", "OFFER_REDEMPTION_DELETE_FAILED", id, null);
            return ResponseEntity.badRequest().body(operationResponse);
        }
    }
    ...
    public ResponseEntity<List<OfferRedemptionResponse>> getRedemptionsByCustomer(@PathVariable Long customerId) {
        ...
        try {
            ...
            log.error("Failed to get redemptions by customer: {}", e.getMessage());
            return ResponseEntity.badRequest().build();
        }
    }
    ...
    public ResponseEntity<List<OfferRedemptionResponse>> getRedemptionsByOffer(@PathVariable Long offerId) {
        ...
        try {
            ...
            log.error("Failed to get redemptions by offer: {}", e.getMessage());
            return ResponseEntity.badRequest().build();
        }
    }
}
